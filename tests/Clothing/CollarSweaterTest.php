...
use Politriukas\Avataaars\Clothing\CollarSweater;
use Politriukas\Avataaars\Tests\GeneratesSvgConstraint;

final class CollarSweaterTest extends TestCase
{
    /**
