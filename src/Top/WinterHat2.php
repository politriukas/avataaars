...
final class WinterHat2 implements Top
{
    ...
    public function generate(): SVGGroup
    {
        ...
        return g([
            defs([
                ...
                path(d: 'M72,21 C126.772655,21 144,68.8032255 144,103.04488 L144,176.910255 C144,196.404852 121.366901,196.446757 121.366901,165.988782 L121.366901,86.5347425 C121.366901,80.4596103 117.635097,77.5347425 111.551408,77.5347425 L72,77.5347425 L32.4485915,77.5347425 C26.3649028,77.5347425 22.6330986,80.4596103 22.6330986,86.5347425 L22.6330986,165.988782 C22.6330986,196.446757 -1.41137102e-14,196.404852 0,176.910255 L0,103.04488 C-7.11930515e-15,68.8032255 17.2273451,21 72,21 Z', id: $path1),
            ...
            g(transform: 'translate(-1.000000, 0.000000)', children: [
                g(strokeWidth: '1', fillRule: 'evenodd', transform: 'translate(61.000000, 0.000000)', children: [
                    g(transform: 'translate(0.000000, 176.000000)', fill: '#F4F4F4', children: [
                        circle(cx: 9, cy: 65, r: 9),
                        rect(x: 8, y: 0, width: 2, height: 58),
                    ]),
                    g(transform: 'translate(126.000000, 168.000000)', fill: '#F4F4F4', children: [
                        circle(cx: 9, cy: 65, r: 9),
                        rect(x: 8, y: 0, width: 2, height: 58),
                    ]),
                    ...
                    svgUse(fill: '#F4F4F4', xlinkHref: "#{$path1}"),
                    $this->hatColor->generate($mask2),
                    rect(fillOpacity: '0.2', fill: '#000000', x: -1, y: 21, width: 146, height: 46, mask: "url(#{$mask2})"),
                    g(transform: 'translate(29.000000, 32.000000)', fill: '#FFFFFF', fillOpacity: '0.5', children: [
                    ...
                    g(transform: 'translate(13.000000, 41.000000)', fill: '#000000', fillOpacity: '0.5', children: [
