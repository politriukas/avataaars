...
final class Kurt implements Accessory
{
    public function generate(): SVGGroup
    {
        $filter = AvatarGlobalId::get('filter-');

        return g(fill: 'none', strokeWidth: '1', transform: 'translate(62.000000, 85.000000)', children: [
            defs([
